...
export function JourneySection({
  ...
  return (
    <section style={{ ...styles.container, marginBottom: dense ? 34 : 46 }}>
      ...
      {block.hasStopover && block.stopover && (
        <div style={{ color: primaryColor, fontSize: dense ? 20 : 24, fontWeight: datesFontWeight, marginBottom: dense ? 12 : 16, marginTop: dense ? -6 : -8 }}>
          {block.stopover}
        </div>
      )}
