  ...
  return (
    <div style={styles.scaleWrapper}>
      ...
      >
        ...
        {payload.footer.hasExtraObservation && payload.footer.extraObservation && footerLayout.extraObservationLine && (
          <div
            data-fit-text
            data-fit-text-lines="1"
            data-fit-text-min="10"
            style={{
              ...styles.footerStrongLine,
              ...toFooterLineStyle(footerLayout.extraObservationLine),
              color: theme.textColor,
              fontWeight: getFontWeightForVariant(footerFontWeights.footerPrimary)
            }}
          >
            {payload.footer.extraObservation}
          </div>
        )}
        <div
          data-fit-text
